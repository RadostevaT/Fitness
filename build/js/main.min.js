...
var _initSwiper = require("./modules/initSwiper");
var _scrollTo = require("./modules/scrollTo");
require("./modules/initVideo");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _initSwiper.initSwiperCoaches)();
    (0, _initSwiper.initSwiperReviews)();
    (0, _scrollTo.initScroll)();
...
},{"./modules/form-validate/form":3,"./modules/initSwiper":9,"./modules/initVideo":10,"./modules/scrollTo":11,"./modules/tabs/init-tabs":12,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";
...
exports.initSwiperReviews = exports.initSwiperCoaches = void 0;
var _swiper = _interopRequireDefault(require("./../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var initSwiperCoaches = function initSwiperCoaches() {
  var swiper = new _swiper.default('[data-swiper-coaches]', {
    // eslint-disable-line
...
exports.initSwiperCoaches = initSwiperCoaches;
...
var iframeBlock = video.querySelector('[data-video-iframe]');
...
var initScroll = function initScroll() {
  var buttons = document.querySelectorAll('[data-scroll-to-button]');
  if (buttons.length) {
